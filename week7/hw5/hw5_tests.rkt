...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (ifaunit (aunit) (int 5) (int 10))) (int 5) "ifaunit test")
   ...
   (check-equal? (eval-exp (call (call mupl-mapAddN (int 5)) (apair (int 2) (apair (int -6) (aunit)))))
                 (apair (int 7) (apair (int -1) (aunit))) "mupl-mapAddN test")
